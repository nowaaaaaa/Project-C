    ...
    <body>
      ...
      <div className='filler-space bg-white dark:bg-slate-800'>
          <div className='text-cyan-800 dark:text-cyan-400'>
            <p className='self-left'>Describe the problem with the selected machine:</p>
            <textarea className='input1 bg-slate-200 dark:bg-slate-600 dark:text-slate-300 py-1 px-1.5 mb-[2vh]'  placeholder=''/>
            <br />
            <p>Describe what the machine is supposed to do:</p>
            <textarea className='input1 bg-slate-200 dark:bg-slate-600 dark:text-slate-300 py-1 px-1.5 md:mb-3' placeholder=''/>
            <br />
