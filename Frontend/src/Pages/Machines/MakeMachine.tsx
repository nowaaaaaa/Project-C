  ...
  return (
    <div className='py-1 '>
      <div className='bg-slate-200 dark:bg-slate-600 text-slate-800 dark:text-cyan-400 mx-auto w-full md:w-3/5'>
        <h1 className='header text-xl text-center bg-slate-300 dark:bg-slate-600 cursor-pointer hover:bg-sky-200 dark:hover:bg-sky-800 ease-in-out duration-150 select-none' onClick={() => setIsActive(!isActive)}>{mach.name} ({Translate(mach.machineTypeName)})</h1>
